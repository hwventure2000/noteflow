...
export default function NoteApp() {
  ...
  const QUOTES = [
    ...
    { text: "You've got to say, I think that if I keep working at this and want it badly enough I can have it.", author: "Lee Iacocca" },
  ...
  const s = {
    ...
    tabRow: (active, dragOver, catColor) => ({ display: "flex", alignItems: "center", padding: "8px 12px", margin: active ? "2px 8px" : "0 0", fontSize: 15, fontWeight: active ? 600 : 400, fontFamily: "'Inter','Helvetica Neue','Segoe UI',sans-serif", letterSpacing: "0.01em", color: active ? (catColor || c.accent) : c.text, background: active ? (catColor ? catColor + "22" : c.accentSoft) : "transparent", borderRadius: active ? 10 : 0, borderLeft: "none", borderTop: dragOver ? `2px solid ${c.accent}` : "2px solid transparent", transition: "all 0.15s", userSelect: "none", gap: 6 }),
